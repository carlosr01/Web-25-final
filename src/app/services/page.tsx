  ...
  return (
    <main className="min-h-screen bg-[#0a0f1e]">
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-[#050910] to-[#0a0f1e] pt-32 pb-20">
        <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_50%_30%,rgba(56,189,248,0.1),transparent_60%)]" />
        <div className="max-w-6xl mx-auto px-6">
          <Reveal>
            <Button variant="ghost" size="sm" asChild className="mb-8 w-fit text-gray-400">
              <Link href="/#hero">
            ...
            {SERVICES.map((service, index) => {
              ...
              return (
                <Reveal key={service.title} delay={index * 0.1}>
                  <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm rounded-3xl p-8 border border-white/10 shadow-2xl hover:shadow-cyan-500/20 transition-shadow">
          ...
          <div className="space-y-8">
            {PROCESS_STEPS.map((item, index) => (
              <Reveal key={item.step} delay={index * 0.1}>
                <div className="relative flex items-start gap-6 bg-slate-800/30 rounded-2xl p-6 border border-white/5 hover:border-cyan-500/20 transition-colors">
            ...
            <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm rounded-3xl p-12 border border-white/10 shadow-2xl">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Button size="xl" asChild>
                  <Link href="https://cal.com/promptadvisers/demo" target="_blank" rel="noopener noreferrer">
                    Agenda una demo
                  </Link>
                </Button>
